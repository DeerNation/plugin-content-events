    ...
    _applyModel: function (value, old) {
      ...
      if (value) {
        ...
        if (content) {
          ...
          this._bindPropertyToChildControl(content, 'organizer', 'organizer', 'label', null, old && old.getPayload(), true)
          this._bindPropertyToChildControl(content, 'location', 'location', 'label', null, old && old.getPayload(), true)
          this._bindPropertyToChildControl(content, 'description', 'description', 'value', null, old && old.getPayload(), true)
